  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
        ...
        >
          We are a team of dedicated professionals committed to transforming your vision into reality. From elegant weddings to grand corporate galas, Mahakal Events delivers excellence, innovation, and a personal touch to every celebration.
        </motion.p>
      </div>
    </section>
  )
